...
#define DSP_SCIA_TX_DATA_LENGTH					(sizeof(S_SCHEDULE_DATA))
#define DSP_SCIA_RX_DATA_LENGTH					(sizeof(S_CELL_SCAN_DATA))
#endif
...
#ifdef	DEVICE_CPU1
#define DSP_SCIA_TX_DATA_LENGTH					(sizeof(S_CELL_SCAN_DATA))
#define DSP_SCIA_RX_DATA_LENGTH					(sizeof(S_SCHEDULE_DATA))
#endif
